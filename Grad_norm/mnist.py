...
if args.add_noise and (args.reg != 'NI'):
    save_file_name = f'data/mnist_{args.reg}_with_noise_{args.alpha_noise}_{args.train_size}_{args.alpha}_{args.model_type}_{args.seed}.pk'
    save_model_name = f'data/mnist_{args.reg}_with_noise_{args.alpha_noise}_{args.train_size}_{args.alpha}_{args.model_type}_{args.seed}.h5'
else:
    save_file_name = f'data/mnist_{args.reg}_{args.train_size}_{args.alpha}_{args.model_type}_{args.seed}.pk'
    save_model_name = f'data/mnist_{args.reg}_{args.train_size}_{args.alpha}_{args.model_type}_{args.seed}.h5'
...
if args.model_type == 'resnet':
    ...
    model, model_with_softmax = mnist_small()
    init_weight_copy = model.get_weights()
    model_with_softmax.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy'])
